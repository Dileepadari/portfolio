...
<table>
  <tr>
    <td width="33%" valign="top">
      <img src="./docs/screenshots/light/01-profile.png" alt="Profile page: bio, highlights, experience and skills" loading="lazy">
      <p align="center"><b>Profile</b><br><sub>Bio, highlights, experience and skills, all editable in place.</sub></p>
    </td>
    <td width="33%" valign="top">
      <img src="./docs/screenshots/light/02-projects.png" alt="Project list, with cards that pick an image per theme" loading="lazy">
      <p align="center"><b>Projects</b><br><sub>46 projects; each card carries a dark and a light image.</sub></p>
    </td>
    <td width="33%" valign="top">
      <img src="./docs/screenshots/light/03-project-showcase.png" alt="A project showcase page addressed by its slug" loading="lazy">
      <p align="center"><b>Project showcase</b><br><sub>One project in full, addressed by slug.</sub></p>
    </td>
  </tr>
  <tr>
    <td width="33%" valign="top">
      <img src="./docs/screenshots/light/04-project-gallery.png" alt="A project's lightbox gallery and the developer sections below it" loading="lazy">
      <p align="center"><b>Gallery and developer half</b><br><sub>A lightbox gallery, then the developer detail behind a divider.</sub></p>
    </td>
    <td width="33%" valign="top">
      <img src="./docs/screenshots/light/05-blog.png" alt="Blog index with markdown posts, comments and likes" loading="lazy">
      <p align="center"><b>Blog</b><br><sub>Markdown posts with threaded comments and per-visitor likes.</sub></p>
    </td>
    <td width="33%" valign="top">
      <img src="./docs/screenshots/light/06-contact.png" alt="Contact page with a message form and a task request form" loading="lazy">
...
<br>
<img src="./docs/screenshots/light/07-project-partial.png" alt="A project with only some sections filled: empty ones are omitted, not left as bare headings" loading="lazy">
</details>
